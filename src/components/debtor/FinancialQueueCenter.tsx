 ...
 export const FinancialQueueCenter = () => {
   ...
   const { data: queueEntries, isLoading } = useFinancialQueue(
     ...
     <div className="space-y-6">
       ...
       <Card>
         <CardHeader className="pb-3">
           ...
           <CardDescription>
             Clear application fees to create trainee accounts • Clear registration fees to complete enrollment
           </CardDescription>
         </CardHeader>
         <CardContent className="space-y-4">
           ...
           <div className="flex gap-2 flex-wrap">
             ...
             <Button
               variant={entityFilter === "APPLICATION" ? "default" : "outline"}
               size="sm"
               onClick={() => setEntityFilter("APPLICATION")}
             >
               <FileText className="h-4 w-4 mr-1" />
               Applications
             </Button>
             <Button
               variant={entityFilter === "REGISTRATION" ? "default" : "outline"}
               size="sm"
               onClick={() => setEntityFilter("REGISTRATION")}
             >
             ...
             <Card>
               <CardContent className="p-12 text-center">
                 ...
                 <p className="text-muted-foreground">
                   No {activeTab === "all" ? "" : activeTab} payments in the queue.
                 </p>
               </CardContent>
             </Card>
           ) : (
         ...
         <DialogContent className="sm:max-w-[500px]">
           <DialogHeader>
             <DialogTitle className="flex items-center gap-2">
               ...
               Clear {selectedEntry?.entity_type === 'APPLICATION' ? 'Application' : 'Registration'} Fee
             </DialogTitle>
             <DialogDescription>
               {selectedEntry && (
                 <>
                   ...
                   {selectedEntry.entity_type === 'APPLICATION' && (
                     <span className="block text-xs mt-1 text-emerald-600">
                       ✓ Trainee account will be created automatically
                     </span>
                   )}
                 </>
               )}
