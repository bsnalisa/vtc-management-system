    ...
    mutationFn: async (applicationData: TraineeApplicationData) => {
      ...
      const { data, error } = await supabase
        ...
        .insert([{
          ...
          id_document_path: applicationData.id_document_path || null,
          school_leaving_cert_path: applicationData.school_leaving_cert_path || null,
          academic_qualifications_path: applicationData.academic_qualifications_path || null,
          additional_documents_paths: applicationData.additional_documents_paths as any || [],
          photo_path: applicationData.photo_path || null,
